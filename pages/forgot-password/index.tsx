...
function forgotPasswordPage() {
  ...
  return (
    <main className="w-full bg-primary-grey min-h-screen relative">
            ...
            <form onSubmit={handleSubmit} className="text-left justify-center h-screen space-y-6 px-6 lg:px-0 max-w-[600px] mx-auto flex flex-col items-center">
        ...
        <Link href="/signin" className='text-right font-semibold text-primary-green w-full'>Sign in</Link>
        <div className="flex justify-between w-full items-center">
          <h4 className="text-2xl font-medium text-gray-600">Send Reset Email</h4>
